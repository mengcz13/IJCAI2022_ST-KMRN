...
import time
import util
import base_models.gw_kae.multires_data as multires_data
from base_models.gw_kae.engine import trainer
from base_models.graph_wavenet.model import gwnet_enc, gwnet_dec
from base_models.gw_kae.multitask_model import MultitaskModel
from base_models.gw_kae.engine import move_data_list
...
def main():
    ...
    wandb.init(project='multires_st', config=args, name='Multitask-GWplusKAE')
    ...
    model = MultitaskModel(
        ...
        res_input_seq_lens=dataloader['x_lens'],
    ...
    engine = trainer(model, scaler, 
                     ...
                     kae_lamb=args.lamb, kae_nu=args.nu, kae_eta=args.eta,
                     kae_lr=args.kae_lr, kae_wd=args.kae_wd, kae_gradclip=args.kae_gradclip, kae_lr_decay=args.kae_lr_decay)
    ...
    if args.eval_saved_model is not None:
        ...
        for i in range(1,args.epochs+1):
            ...
            engine.kae_scheduler.step(mvalid_loss['kae_loss'])
